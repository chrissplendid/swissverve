...
<html lang="en" dir="ltr" data-startbar="dark" data-bs-theme="light" data-beasties-container="">
...
<style>@-webkit-keyframes ball-spin-clockwise{0%,to{opacity:1;-webkit-transform:scale(1);transform:scale(1)}20%{opacity:1}80%{opacity:0;-webkit-transform:scale(0);transform:scale(0)}}body{font-family:Roboto,sans-serif}.whatsapp-float{position:fixed;bottom:20px;left:20px;z-index:1000}body{top:0!important}</style><link rel="stylesheet" href="styles-DYCMQPSC.css" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="styles-DYCMQPSC.css"></noscript></head>
